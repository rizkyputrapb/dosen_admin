                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="KODE" name="KODE" value="<?php echo $dosen['KODE'] ?>" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="noTelp" name="noTelp" value="<?php echo $dosen['noTelp'] ?>">
                        </div>
